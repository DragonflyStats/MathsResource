...
\lhead{MA4702}\chead{MID TERM EXAM 2}\rhead{16th March 2016}
...
\begin{enumerate}[(i)]
	\item (2 Marks) Determine if the function $f(x) = x^2 \cos(x)$ is an even function, an odd function or neither. Justify your answer.
\vspace{8.8cm}
