...
% %- https://en.wikibooks.org/wiki/Calculus/Differentiation/Basics_of_Differentiation/Exercises
{
\Large
\begin{multicols}{2}
\begin{itemize}
...
\subsection*{Part H : Trigonometric functions}
{
	...
	\begin{multicols}{2}
		\begin{itemize}
		%	\item[51] $ f(x) = 3e^x-4\cos (x) - \frac{1}{4}\ln x$ \,
...
\end{document}
	...
	\subsection*{Question 17 : Revision of Differentiation}
	\Large
