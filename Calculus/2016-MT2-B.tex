...
\begin{enumerate}[(i)]
	\item (2 Marks) Suppose the general term $u_n$ is given as \[u_n = \displaystyle{\frac{n!}{5^n} } .\]State $u_{n+1}$ and hence calculate a simplified expression for $r$, where 
	{
		\Large
		\[ r = \frac{u_{n+1}}{u_n}\]
	}
\vspace{8.8cm}
	...
	\item (2 Mark) Given the function $g(x) = \sqrt{x-2}$ find the inverse of the function $g^{-1}(x)$.
...
\[g(x)= x^2 - 3x  +1\]    \[f(x) = \sqrt{x-1}\] Determine the values of $f \circ g(2)$ and $g \circ f(2)$. Show your workings.	
