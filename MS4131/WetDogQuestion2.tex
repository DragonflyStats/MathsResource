...
3  & -2  &  5\\
	...
	\end{equation*}
			...
			\begin{itemize}
				\item[(i)] (2 Mark) Write down the coefficient matrix and the augmented matrix of this system. %\marks{4}
...
\begin{itemize}
	...
	\smallskip\item[(iv)] (1 Mark) With reference to the answer for part (iii), state the scalar triple product  $u\cdot(w \times v)$. Justify your answer. %\marks{3}
\end{itemize}
\smallskip
